 ...
 */
async function evaluateRegistration(registration: ServiceWorkerRegistration): Promise<void> {
...
export function watchPwaRegistration(registration: ServiceWorkerRegistration): void {
...
export async function applyWebUpdate(): Promise<void> {
  ...
  const { promise: activated, resolve: finishActivation } = Promise.withResolvers<void>()
  const finish = () => {
