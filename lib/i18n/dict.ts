export const zh = {
  ...
  gpa: {
    ...
    encourageA: "这就是大佬吗，恐怖如斯 (ﾟ▽ﾟ)/",
    encourageB: "稳得很，再拱一拱就进 A 区了 (｀・ω・´)",
    encourageC: "人在 C 区，心向 B 区，冲鸭 (ง •̀_•́)ง",
    encourageLow: "别怕，下学期把场子找回来 qwq",
...
export const en = {
  ...
  gpa: {
    ...
    encourageA: "Certified big-brain energy (ﾟ▽ﾟ)/",
    encourageB: "Solid! One more push to the A zone (｀・ω・´)",
    encourageC: "Currently in C, aiming for B — go go (ง •̀_•́)ง",
    encourageLow: "It's fine — reclaim the arena next term qwq",
